...
<?php include('../layout/head.html'); ?>
  ...
  <title>SisEval - Tipos de Evaluación</title>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                  ...
                  <div class="col ml-2">
                      <a class="float-right" data-toggle="modal" data-target="#AgregarTipoDeEvaluacionModal" onclick="LimpiarFormulario();"><i class="fas fa-plus fa-2x text-primary"></i></a>
                  </div>
                </div>
            </div>
