...
<?php include('../layout/head.html'); ?>
  ...
  <title>SisEval - Factores</title>


</head>

<body id="page-top" onload="ObtenerFactores();">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col">
                        <h6 class="m-0 font-weight-bold text-primary">Lista De Factores</h6>
                        <input type="hidden" id="IdOculto" value="0" />
                    </div>
                  <div class="col ml-2">
                      <a class="float-right" data-toggle="modal" data-target="#AgregarFactorModal" onclick="LimpiarFormulario();"><i class="fas fa-plus fa-2x text-primary"></i></a>
                  </div>
                </div>
            </div>
            ...
            <div class="card-body">
              <div class="table-responsive">
                  <table class="table table-bordered DatosFactores" width="100%" cellspacing="0">
                      <thead>
                        <tr>
                        <th>Id</th>
                        <th>Nombre Factor</th>
                        <th>Descripcion Factor</th>
  ...
  <div class="modal fade" id="AgregarFactorModal" tabindex="-1" role="dialog" aria-labelledby="exampleAddUserModal" aria-hidden="true">
