...
<body id="page-top" onload="ObtenerPuestos();">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Pagina de Puestos</h1>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                  ...
                  <div class="col ml-2">
                      <a class="float-right" data-toggle="modal" data-target="#AgregarPuestoModal" onclick="LimpiarFormulario();"><i class="fas fa-user-plus fa-2x text-primary"></i></a>
                  </div>
                </div>
            </div>
  ...
  <div class="modal fade" id="AgregarPuestoModal" tabindex="-1" role="dialog" aria-labelledby="exampleAddUserModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleAddUserModal">Registro de Puestos</h5>
