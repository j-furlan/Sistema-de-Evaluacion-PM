          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                  ...
                  <div class="col ml-2">
                      <a class="float-right" data-toggle="modal" data-target="#AgregarPuestoModal" onclick="LimpiarFormulario();"><i class="fas fa-plus fa-2x text-primary"></i></a>
                  </div>
                </div>
            </div>
